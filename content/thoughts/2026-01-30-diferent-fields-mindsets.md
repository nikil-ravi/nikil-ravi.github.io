...
This often applies to teams. In any group project — a startup or research lab, say — if your initial team is excellent (great init, good architecture), and you listen to your empirical results (market feedback, research outcomes), move fast (good learning rate), and backpropagate signals into the team well, you will win.

In this situation, the math mindset leads to analysis paralysis, and does not serve you well here.

This mindset shift extends to other fields too. Programming has its own mindset, as do physics, or manufacturing. Being able to pick up these mindsets and decide which model of thought applies to a given situation seems like a pretty valuable skill.
