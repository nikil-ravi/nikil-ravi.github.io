---
title: "Scattered Thoughts on the State of Evals"
date: 2025-12-25
draft: false
listed: true
...
- **Some unanswered questions**: What paradigms are currently missing from evaluation today? What is the longer term way to evaluate AI systems? When we run evaluations on AI models, what are we actually measuring? I do not know the answers here, but I think the following directions are worth exploring: [persona-based evaluation](https://arxiv.org/pdf/2411.10109), [ideas from psychometrics](https://arxiv.org/pdf/2505.08245), and [studying/monitoring how they work in production](https://arxiv.org/pdf/2512.04123). 


In general, it seems weird that we have access to the weights of the entity we're evaluating (an advantage over evaluating humans, where we don't really have access to the brain in a meaningful way), and yet we rely on methods that are similar to how we typically evaluate humans.
